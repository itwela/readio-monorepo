...
export const systemPromptReplicateImageQuery = `
	...
	3.	IMPORTANT: If your image prompt includes any person or people, they should be depicted as African American. This applies to all human figures, whether they are specific individuals, generic representations, or background figures.
	4.	Stylize the subject using cinematic direction—just like designing a meaningful book or album cover.
    ...
    All of these features from lighting, texture, camera angle, and artifacts should be present in the image prompt you generate. Follow directions.
