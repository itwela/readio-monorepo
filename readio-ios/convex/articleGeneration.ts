...
import { EL_SticVoiceId, kokoroString, metaLlamaString, systemPromptForArticleTitle, systemPromptChooseCategory, systemPromptNSFW, systemPromptForArticleGeneration } from "./constants";
  ...
  handler: async (ctx, args): Promise<{
    ...
    try {
      ...
      const imagePromptInput = {
        ...
        system_prompt: `You create detailed, cinematic image prompts for AI art generation. 
        Focus on visual composition, lighting, mood, and artistic style. 
        Make it photorealistic and emotionally resonant with the article content.
        Always include specific details about lighting, composition, and atmosphere.`,
        stop_sequences: "<|end_of_text|>,<|eot_id|>",
        prompt_template: "<|begin_of_text|><|start_header_id|>system<|end_header_id|>\\n\\n{system_prompt}<|eot_id|><|start_header_id|>user<|end_header_id|>\\n\\n{prompt}<|eot_id|><|start_header_id|>assistant<|end_header_id|>\\n\\n",
        presence_penalty: 0,
        length_penalty: 1,
