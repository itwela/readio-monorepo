...
with_node \
  ...
  --target "/Users/itwelaibomu/Documents/Github/readio-monorepo/readio-ios/ios/Pods/Target Support Files/Pods-Lotus/ExpoModulesProvider.swift" \
  --entitlement "/Users/itwelaibomu/Documents/Github/readio-monorepo/readio-ios/ios/Lotus/Lotus.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-blur" "expo-constants" "expo-crypto" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-haptics" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-location" "expo-router" "expo-secure-store" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser" "react-native-image-colors"
