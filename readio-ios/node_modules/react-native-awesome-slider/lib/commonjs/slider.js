...
const Slider = exports.Slider = /*#__PURE__*/(0, _react.memo)(function Slider({
  ...
  const isTouchInThumbRange = (0, _reactNativeReanimated.useSharedValue)(false);
  const thumbIndex = (0, _reactNativeReanimated.useSharedValue)(0);
  ...
  const thumbPosition = (0, _reactNativeReanimated.useDerivedValue)(() => {
  ...
  const onGestureEvent = (0, _react.useMemo)(() => {
    const gesture = _reactNativeGestureHandler.Gesture.Pan().hitSlop(panHitSlop).onBegin(({
      x
    }) => {
  ...
  (0, _reactNativeReanimated.useAnimatedReaction)(() => {
    ...
    if (snappingEnabled) {
      ...
      thumbIndex.value = (0, _utils.clamp)(index, 0, step);
    }
  ...
  (0, _reactNativeReanimated.useAnimatedReaction)(() => {
    ...
    return (0, _utils.clamp)(currentIndex, 0, step);
  }, data => {
  ...
  return /*#__PURE__*/_react.default.createElement(_reactNativeGestureHandler.GestureDetector, {
    gesture: gesture
  }, /*#__PURE__*/_react.default.createElement(_hitSlop.HitSlop, panHitSlop, /*#__PURE__*/_react.default.createElement(_reactNativeReanimated.default.View, {
    testID: testID,
    style: [styles.view, {
      height: sliderHeight
    }, style],
    ...
    return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, {
      key: i
    }, renderTrack && /*#__PURE__*/_react.default.createElement(_reactNative.View, {
      ...
      index: i
    })), renderMark ? /*#__PURE__*/_react.default.createElement(_reactNative.View, {
